...
public:
	 ...
	 *	}
	 *
	 *	@para row_index : the index of row in the row-major format
	 ...
	 *	@para row_result : the result get from the get_row_result() method
	 *	@para col_index : the index of col in the row-major format
